...
# this part:
# Create partition, Format disk, Crypt partition, 
clear
echo "THIS WILL FORMAT AND DELETE ALL DATA ON THE DISK ${DISK}"
...
# Crypt partion first
# and then format btrfs /dev/mapper/cryptroot
# youtube https://youtu.be/ybvwikNlx9I?t=1237
...
# youtube: https://youtu.be/7ituCCKXmMM?t=340
